...
router.post("/reset-password-request", auth_controller_1.AuthUserControllers.resetPasswordRequest);
router.post("/set-new-password", auth_controller_1.AuthUserControllers.resetPassword);
